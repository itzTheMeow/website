<script lang="ts">
  ...
  export let offset: number, project: ProjectJSON;
</script>

<div
  class="rounded-lg p-3 box-border transition hover:brightness-[1.15] cursor-pointer"
  style:background={generateUltrablurCSS(project.color, Colors.primary, 25, 4)}
